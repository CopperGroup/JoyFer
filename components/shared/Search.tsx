    ...
    <>
      <div className='w-full flex gap-3 max-md:text-black'>
        <Image
          ...
          alt="Seacrh"
        />
        <Input className="appearance-none rounded-none" type='text' onChange={textFromInput}  placeholder='Пошук товару' />
      </div>
      <Select onValueChange={(element: SortParams) => setSort(element)} >
        <SelectTrigger className="w-[240px] max-[600px]:hidden rounded-none">
